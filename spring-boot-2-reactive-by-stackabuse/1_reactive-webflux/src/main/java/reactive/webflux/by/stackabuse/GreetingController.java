...
public class GreetingController {
  ...
  public Publisher<Greeting> greetingPublisher() {
    return Flux.<Greeting>generate(sink -> sink.next(greeting()))
  ...
  public Flux<Greeting> greetingSseZip() {
    Flux<Greeting> greetingFlux = Flux.fromStream(Stream.generate(this::greeting)).take(10);
