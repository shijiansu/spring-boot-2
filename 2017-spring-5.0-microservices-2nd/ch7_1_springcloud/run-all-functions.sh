...
# config server load balancer -> load balancing to 8888 and 8889
...
# eureka server - connect to ha config server solution
...
# eureka server load balancer -> load balancing to 8761 and 8762
...
# website load balancer -> load balancing to 8001 and 8002
...
# link - eureka servers load balancer
